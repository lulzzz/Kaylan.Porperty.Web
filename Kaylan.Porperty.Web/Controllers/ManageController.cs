...
using Kaylan.Porperty.Web.Models;
...
namespace Kaylan.Porperty.Web.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        public ActionResult LinkLogin(string provider)
        {
            ...
            return new AccountController.ChallengeResult(provider, Url.Action("LinkLoginCallback", "Manage"), Convert.ToString(User.Identity.GetUserId<int>()));
        }
        ...
        {
            var loginInfo = await AuthenticationManager.GetExternalLoginInfoAsync(XsrfKey, Convert.ToString(User.Identity.GetUserId<int>()));
            if (loginInfo == null)
            {
