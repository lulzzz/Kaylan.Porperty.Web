	jQuery(document).ready(function($){
		...
		imgPathStart = "http://preview.imithemes.com/real-spaces-wp/wp-content/themes/real-spaces/style-switcher/backgrounds/patterns/";
		...
		imgPathStart1 = "http://preview.imithemes.com/real-spaces-wp/wp-content/themes/real-spaces/style-switcher/backgrounds/images/";
		...
		$("ul.layouts li.boxed-layout").click(function(){
			$("body").addClass("boxed");
			$("ul.layouts li").removeClass("active");
           $.cookie('boxed','yes', {expires: 7});
           $("body").addClass("boxed");
			$(this).addClass("active");
           $.cookie('wide','no',  {expires: 7});
			return false;
		});		
